...
class Web_Scrapper:
    def __init__ (self, recepie_name = "Panner Butter Masala"):
        self.url_cuisines = "https://www.allrecipes.com/cuisine-a-z-6740455"
    ...
    def scrape_recipes (self, cuisines = '', recipies = ''):
        ...
        for index_c, cuisines in enumerate(self.recipe_handle.cuisine_names.keys()):
            ...
            for index_r, recipe in enumerate(self.recipe_handle.recipe_dict[cuisines].keys()):
                ...
                for index_d, steps in enumerate(directions_steps):
                    ...
                    self.update_dict(index_d, directions_step_wise.text,\
        ...
        self.recipe_handle.write_to_file(self.recipe_handle.recipe_details, "recipe_details.json")
